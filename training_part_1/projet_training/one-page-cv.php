...
<?php include './elements/header-one-page.php' ?>
...
<?php include './elements/sidebar.php' ?>
    ...
    <div class="container-full-width">
      ...
      <div class="section-one-page" id="test-scroll">
        <div class="row">
          <div class="col-md-4 content-one image-content-cv">
            <!-- <img src="/image/thomas-jaune2.jpg"> -->
          </div>
          <div class="col-md-8 content-two text-about-me">
            <div class="title-about-me">
              <h1>About me</h1>
            </div>
            <h3>I was born in Lyon in 1994</h3>
            <p>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Earum temporibus numquam, laboriosam magnam suscipit molestiae vel incidunt ipsa labore, quas nobis. Autem, ut? Voluptatibus veniam ullam eos magnam fuga adipisci.
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cupiditate obcaecati deserunt harum delectus corrupti praesentium totam, a quidem at dicta, exercitationem voluptatem aspernatur ducimus optio dolor nesciunt nam quisquam doloribus!
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Modi architecto cupiditate qui ex sint, ducimus aliquid consectetur nulla perferendis voluptate ipsam est, quo error facere maiores esse molestiae mollitia quos.
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Earum temporibus numquam, laboriosam magnam suscipit molestiae vel incidunt ipsa labore, quas nobis. Autem, ut? Voluptatibus veniam ullam eos magnam fuga adipisci.
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cupiditate obcaecati deserunt harum delectus corrupti praesentium totam, a quidem at dicta, exercitationem voluptatem aspernatur ducimus optio dolor nesciunt nam quisquam doloribus!
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Modi architecto cupiditate qui ex sint, ducimus aliquid consectetur nulla perferendis voluptate ipsam est, quo error facere maiores esse molestiae mollitia quos.
            </p>
      ...
      <div class="separator" id="section-two"></div>
      <div class="timeline-container" id="timeline-1">
        ...
        <div class="timeline">
          <div class="timeline-item" data-text="NEW TIMELINE DESIGN">
            <div class="timeline__content"><img class="timeline__img" src="/image/img1.jpg" />
          ...
          <div class="timeline-item" data-text="NEW TIMELINE DESIGN">
            <div class="timeline__content"><img class="timeline__img" src="/image/img2.jpg" />
          ...
          <div class="timeline-item" data-text="NEW TIMELINE DESIGN">
            <div class="timeline__content"><img class="timeline__img" src="/image/img3.jpg" />
      ...
      <div class="separator" id="section-three"></div>
      <div class="section-card container">
        <div class="card">
          <div class="img-card-one-page" data-text="design">
            <img src="/image/logo/php.png">
          </div>
          <div class="content-card-one-page">
            <h3>desgin</h3>
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolore labore perferendis sed modi quibusdam, laudantium dicta, mollitia ea tempore corrupti, architecto fuga asperiores? Corporis perspiciatis voluptatum voluptas vitae ipsam quis.</p>
            <a href="#">read more</a>
          </div>
        </div>
        <div class="card">
    ...
    <div class="section-one-page" id="section-four">
      <div class="column">
        <div class="separator" id="section-four"></div>
        <h1 id="h1-section-five">My hobbies</h1>
      </div>
      <div class="row col-md-12">
        <div class="col-md-3">
          <div class="passions-content">
            <h2>Developpement</h2>
            <img src="/image/icon/computer.png" alt="">
          </div>
          <div class="passions-hidden-text">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum, ea soluta error hic vitae odio tempore distinctio fugit dolor aspernatur!</p>
          </div>
        </div>
        <div class="col-md-3">
          <div class="passions-content">
            <h2>Nature</h2>
            <img src="/image/icon/montain.png" alt="">
          </div>
          <div class="passions-hidden-text">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum, ea soluta error hic vitae odio tempore distinctio fugit dolor aspernatur!</p>
          </div>
        ...
        <div class="col-md-3">
          <div class="passions-content">
            <h2>Sport</h2>
            <img src="/image/icon/exercise.png" alt="">
          </div>
          <div class="passions-hidden-text">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum, ea soluta error hic vitae odio tempore distinctio fugit dolor aspernatur!</p>
          </div>
        ...
        <div class="col-md-3">
          <div class="passions-content">
            <h2>Video games</h2>
            <img src="/image/icon/videogames.png" alt="">
          </div>
          <div class="passions-hidden-text">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum, ea soluta error hic vitae odio tempore distinctio fugit dolor aspernatur!</p>
          </div>
    ...
    <div  id="section-five">
      <?php include_once './elements/contact-me-form.php' ?>
    </div>
    </div>
    </div>
    <?php include_once './elements/btn-bottom-top-scroll.php' ?>

    <?php include './elements/footer-one-page.php' ?>
